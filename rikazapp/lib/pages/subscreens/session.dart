...
class _SessionPageState extends State<SessionPage>
  ...
  void _showMotivationalPopup(String distraction) {
    String message = "";
    if (distraction == 'low') {
      message = "Great job staying focused! You're on fire! 🌟";
    } else if (distraction == 'medium') {
      message = "Good effort! Consistency is key. 💪";
    } else {
      message = "Don't be hard on yourself, every bit counts! 🌱";
    }
